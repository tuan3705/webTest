...
WebUI.verifyElementClickable(findTestObject('Page_Home/VolunteerHub'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Page_Home/button_login'))
